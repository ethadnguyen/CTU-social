...
const Home = () => {
  ...
  const handleDeleteGroup = async (groupId) => {
    ...
    if (result.isConfirmed) {
      try {
        const res = await axiosInstance.delete(`/admin/delete-group/${groupId}`);
          ...
          <div className="flex-col hidden w-1/3 h-full gap-3 overflow-y-auto lg:w-1/4 md:flex">
            ...
            <div className="rounded-md h-full">
              <ul className="bg-primary rounded-md h-full">
                <li
                  className={`pl-6 py-3 cursor-pointer hover:bg-gray text-ascent-1 ${activeTab === "nhom" ? "bg-sky" : ""
                    } rounded-md`}
                ...
                <li
                  className={`pl-6 py-3 cursor-pointer hover:bg-gray text-ascent-1 ${activeTab === "quanLyNhom" ? "bg-sky" : ""
                    } rounded-md`}
                ...
                <li
                  className={`pl-6 py-3 cursor-pointer hover:bg-gray text-ascent-1 ${activeTab === "nguoiDung" ? "bg-sky" : ""
                    } rounded-md`}
                ...
                <li
                  className={`pl-6 py-3 cursor-pointer hover:bg-gray text-ascent-1 ${activeTab === "khoa" ? "bg-sky" : ""
                    } rounded-md`}
                ...
                <li
                  className={`pl-6 py-3 cursor-pointer hover:bg-gray text-ascent-1 ${activeTab === "hoatDong" ? "bg-sky" : ""
                    } rounded-md`}
            ...
            {activeTab === "quanLyNhom" && (
              <div className="h-full">
                ...
                {groups
                  ...
                  .map((group) => (
                    <div key={group._id} className="flex items-center mb-2">
                      ...
                      <div className="rounded-md flex flex-col bg-primary py-3 px-3 w-full">
                        ...
                        <div className="relative">
                          ...
                          />
                          <Link
                            to={`${import.meta.env.VITE_CLIENT_URL}/group/${group?._id}`}
